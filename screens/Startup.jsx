...
const Startup = ({ navigation }) => {
  return (
    <View style={style.container}>
      ...
      <Text style={style.preText}>
        Looking for that book on the web is not easy, Here you just tell us the
        book title or the topic and we organise your results.
      </Text>
      <TouchableOpacity
        style={style.button}
        onPress={() => {
      ...
      <Text style={{ color: "rgba(0,0,255,255)", fontWeight: "bold" }}>
        TRINETECHNOLOGIES
      </Text>
      {/* <BannerAd
