...
export default function App() {
  ...
  useEffect(() => {
    db.execAsync(`CREATE TABLE IF NOT EXISTS "Downloads" ("ID" INTEGER PRIMARY KEY AUTOINCREMENT,"Title"	TEXT UNIQUE,"Authors"	TEXT,	"Description"	TEXT,"Poster"	TEXT,	"Language"	TEXT,	"Size"	TEXT,	"Url"	TEXT,	"Link"	TEXT,	"Extension"	TEXT)`,[])
    db.execAsync(`CREATE TABLE IF NOT EXISTS "Recent" ("ID" INTEGER PRIMARY KEY AUTOINCREMENT,"Title"	TEXT UNIQUE,	"Authors"	TEXT,	"Description"	TEXT,	"Poster"	TEXT,	"Language"	TEXT,	"Size"	TEXT,	"Url"	TEXT,	"Link"	TEXT,	"Extension"	TEXT)`,[])
  }, [])
